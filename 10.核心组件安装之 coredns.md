...
kube-system   calico-kube-controllers-b49d9b875-zx5m7   1/1       Running   1          21h
kube-system   calico-node-8ctw7                         2/2       Running   2          21h
kube-system   calico-node-gjvqv                         2/2       Running   2          21h
kube-system   calico-node-qnh52                         2/2       Running   2          21h
kube-system   calico-node-rptbk                         2/2       Running   2          21h
kube-system   calico-node-tnn6z                         2/2       Running   2          21h
kube-system   coredns-6c65fc5cbb-84nd6                  1/1       Running   0          3m
kube-system   coredns-6c65fc5cbb-w5cnv                  1/1       Running   0          3m
```
#### 部署测试nginx pod进行测试
```
...
$ kubectl get pod --all-namespaces
NAMESPACE     NAME                                      READY     STATUS    RESTARTS   AGE
default       my-nginx-7c4dc6b5b6-6q2dz                 1/1       Running   0          1m
default       my-nginx-7c4dc6b5b6-8rckr                 1/1       Running   0          1m
default       nginx                                     1/1       Running   0          16s
kube-system   calico-kube-controllers-b49d9b875-zx5m7   1/1       Running   1          21h
kube-system   calico-node-8ctw7                         2/2       Running   2          21h
kube-system   calico-node-gjvqv                         2/2       Running   2          21h
kube-system   calico-node-qnh52                         2/2       Running   2          21h
...
PING my-nginx.default.svc.cluster.local (10.254.79.234): 48 data bytes
56 bytes from 10.254.79.234: icmp_seq=0 ttl=64 time=0.076 ms
56 bytes from 10.254.79.234: icmp_seq=1 ttl=64 time=0.114 ms
56 bytes from 10.254.79.234: icmp_seq=2 ttl=64 time=0.083 ms
^C--- my-nginx.default.svc.cluster.local ping statistics ---
3 packets transmitted, 3 packets received, 0% packet loss
round-trip min/avg/max/stddev = 0.076/0.091/0.114/0.000 ms
