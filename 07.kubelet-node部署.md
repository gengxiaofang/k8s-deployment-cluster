...
$ for node_ip in ${NODE_IPS[@]}
  do
    echo ">>> ${node_ip}"
    sed -i "s@##NODE_IP##@${node_ip}@" kubelet-csr.json
    cfssl gencert -ca=/etc/kubernetes/ssl/ca.pem -ca-key=/etc/kubernetes/ssl/ca-key.pem -config=/etc/kubernetes/ssl/ca-config.json -profile=kubernetes kubelet-csr.json | cfssljson -bare kubelet-${node_ip}
